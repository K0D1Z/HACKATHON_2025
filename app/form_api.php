...
// Nagłówki CORS i konfiguracja metody
...
// Użyj drugiego typu lub powtórz pierwszy, aby zapytanie SQL nie było puste
$secondaryProfile = $profileParts[1] ?? $mainProfile; 
...
try {
    ...
    if (!empty($jobIds)) {
        ...
        // Próba 1: Edukacja pasująca do celu użytkownika (typ: studia, kurs, technikum)
        if ($goal !== 'brak') {
        ...
        // Fallback: Pokaż wszystkie typy edukacji
